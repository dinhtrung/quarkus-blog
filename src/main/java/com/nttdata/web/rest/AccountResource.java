...
import com.nttdata.service.InvalidPasswordException;
import com.nttdata.service.MailService;
import com.nttdata.service.UserService;
import com.nttdata.service.UsernameAlreadyUsedException;
import com.nttdata.service.dto.PasswordChangeDTO;
import com.nttdata.service.dto.UserDTO;
import com.nttdata.web.rest.errors.EmailAlreadyUsedException;
import com.nttdata.web.rest.errors.EmailNotFoundException;
import com.nttdata.web.rest.errors.LoginAlreadyUsedException;
import com.nttdata.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.nttdata.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
