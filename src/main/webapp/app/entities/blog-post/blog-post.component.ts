...
export class BlogPostComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.blogPostService
      ...
      .subscribe(
        (res: HttpResponse<IBlogPost[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IBlogPost): string {
  ...
  registerChangeInBlogPosts(): void {
    this.eventSubscriber = this.eventManager.subscribe('blogPostListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IBlogPost[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
